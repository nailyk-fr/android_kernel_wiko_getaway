...
#include "i2c.h"
void bq24158setDefaultV(void);//LINE<20131009><battery locked>mickal.ma
...
int hw_check_battery(void)
{
    ...
    else
    {
        ...
        #if defined(MTK_BQ24158_SUPPORT)
		bq24158setDefaultV();//LINE<20131009><battery locked>mickal.ma
        #endif		
...
//BEGIN<20131009><battery locked>mickal.ma
#if defined(MTK_BQ24158_SUPPORT)
...
void bq24158setDefaultV(void)
{
	...
	write_data[0]=0x6;
	//write_data[1]=0x70;
	write_data[1]=0x77; //LINE<JIRA_ID><DATE20131009><s7611 high bat>mickal.ma
	...
	write_data[0]=0x2;
	#if defined(PROJECT_L4550)
	write_data[1]=0xaa;	//LINE<JIRA_ID><DATE20131008><s7611 high bat>mickal.ma
	#else
	write_data[1]=0x8e;	
	#endif
	i2c_write(&bq24158_i2c, write_data, 2);	
...
#endif
//END<20131009><battery locked>mickal.ma
