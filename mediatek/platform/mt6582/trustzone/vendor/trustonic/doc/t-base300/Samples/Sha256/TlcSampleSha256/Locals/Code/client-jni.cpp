...
#define LOG_TAG "TlcSampleSha256"
#include "log.h"
...
Java_com_trustonic_tsdk_sample_TlcSampleSha256_sha256(
	JNIEnv *env,
	jobject obj,
	jbyteArray srcbuf,
    jint srcbuflen,
    ...
    ret = sha256((uint8_t*)src, srcbuflen, (uint8_t*)dst, dstbuflen);
...
EXTERN_C JNIEXPORT jint JNICALL
Java_com_trustonic_tsdk_sample_TlcSampleSha256_open(
	JNIEnv *env,
	jobject obj,
	jbyteArray pTAData,
    jint nTASize
...
Java_com_trustonic_tsdk_sample_TlcSampleSha256_close(
	JNIEnv *env,
	jobject obj
) {
	LOG_I("%s", __func__);
