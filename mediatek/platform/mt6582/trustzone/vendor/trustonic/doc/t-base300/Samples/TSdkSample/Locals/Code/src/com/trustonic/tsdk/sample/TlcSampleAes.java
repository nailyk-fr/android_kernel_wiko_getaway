...
public class TlcSampleAes {

	public static native int open(byte[] tabuf, int tabuflen);

	public static native int aes(byte[] srcbuf, int srcbuflen, byte[] dstbuf, int dstbuflen);

	public static native int secureObject(byte[] srcbuf, int srcbuflen, byte[] dstbuf, int dstbuflen);
	 ...
	 */
	static {
		System.loadLibrary("TlcSampleAes");
	}
}
