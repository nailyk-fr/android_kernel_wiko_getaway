...
#define DECLARE_HEAP(_name_,_size_) \
            _BEGIN_EXTERN_C \
                ...
                _UNUSED extern const uint32_t  _HEAP_ENTRIES_VAR(_name_) = BYTE_SIZE_TO_HEAP_ENTRY_COUNT(_size_); \
            _END_EXTERN_C
...
#define DECLARE_HEAP(_name_,_size_) \
            _BEGIN_EXTERN_C \
                ...
                _UNUSED const uint32_t  _HEAP_ENTRIES_VAR(_name_) = BYTE_SIZE_TO_HEAP_ENTRY_COUNT(_size_); \
            _END_EXTERN_C
