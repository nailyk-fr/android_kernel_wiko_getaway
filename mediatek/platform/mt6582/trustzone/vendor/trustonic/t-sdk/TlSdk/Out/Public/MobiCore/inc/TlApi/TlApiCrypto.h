...
typedef enum {
    ...
    TLAPI_ALG_3DES_CBC_ISO9797_M1       = (AF_CIPHER | AF_CIPHER_3DES | 1),  /**< Triple DES with key size 128 bit in outer CBC mode, padding according to the ISO 9797 method 1 scheme. */
    TLAPI_ALG_3DES_CBC_ISO9797_M2       = (AF_CIPHER | AF_CIPHER_3DES | 2),  /**< Triple DES with key size 128 bit in outer CBC mode, padding according to the ISO 9797 method 2 (ISO 7816-4, EMV'96) scheme. */
    TLAPI_ALG_3DES_CBC_NOPAD            = (AF_CIPHER | AF_CIPHER_3DES | 3),  /**< Triple DES with key size 128 bit in outer CBC mode, no padding. */
    TLAPI_ALG_3DES_CBC_PKCS5            = (AF_CIPHER | AF_CIPHER_3DES | 4),  /**< Triple DES with key size 128 bit in outer CBC mode, padding according to the PKCS#5 scheme. */
#if TBASE_API_LEVEL >= 3
    TLAPI_ALG_3DES_128_CBC_ISO9797_M1   =  TLAPI_ALG_3DES_CBC_ISO9797_M1,
    TLAPI_ALG_3DES_128_CBC_ISO9797_M2   =  TLAPI_ALG_3DES_CBC_ISO9797_M2,
    TLAPI_ALG_3DES_128_CBC_NOPAD        =  TLAPI_ALG_3DES_CBC_NOPAD,
    TLAPI_ALG_3DES_128_CBC_PKCS5        =  TLAPI_ALG_3DES_CBC_PKCS5,
    TLAPI_ALG_3DES_192_CBC_ISO9797_M1   = (AF_CIPHER | AF_CIPHER_3DES | 5),  /**< Triple DES with key size 192 bit in outer CBC mode, padding according to the ISO 9797 method 1 scheme. */
    TLAPI_ALG_3DES_192_CBC_ISO9797_M2   = (AF_CIPHER | AF_CIPHER_3DES | 6),  /**< Triple DES with key size 192 bit in outer CBC mode, padding according to the ISO 9797 method 2 (ISO 7816-4, EMV'96) scheme. */
    TLAPI_ALG_3DES_192_CBC_NOPAD        = (AF_CIPHER | AF_CIPHER_3DES | 7),  /**< Triple DES with key size 192 bit in outer CBC mode, no padding. */
    TLAPI_ALG_3DES_192_CBC_PKCS5        = (AF_CIPHER | AF_CIPHER_3DES | 8),  /**< Triple DES with key size 192 bit in outer CBC mode, padding according to the PKCS#5 scheme. */
